...
public class HibernateFeatureRepository extends HibernateGenericRepository<Feature> implements FeatureRepository {
    ...
    public List<String> getAvailableFeatureClasses() {
        ...
        log.debug("Enetered getAvailableFeatureClasses()");
    ...
    public List<Feature> getFeaturesByBoxAndFeatureClassName(Map<String, Double> boundingBox, String featureClassName) {
        ...
        log.debug("Entered getFeaturesByBoxAndFeatureClassName()");
    ...
    @Override
    public int deleteByStateGeoId(String stateGeoId) {

        log.debug("Entered deleteByStateGeoId(), stateGeoId: {}", stateGeoId);
